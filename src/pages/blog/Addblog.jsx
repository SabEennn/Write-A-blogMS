...
const Addblog = () => {
  return (
    <Layout>
      ...
      <form className="m-10 w-1/2 border-2 p-10">
        <div className="py-5">
        ...
        <div className="title-wrapper">
          ...
          <textarea
            id="message"
            rows="4"
            className="bg-slate-100 focus:bg-transparent focus:outline-none block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 border-none"
        ...
        <div className="w-full mb-4 border-none border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-700 dark:border-gray-600">
          ...
          <div className=" py-2 bg-white rounded-b-lg dark:bg-gray-800">
            ...
            <textarea
              id="editor"
              rows="8"
              className="bg-slate-100 focus:outline-none focus:bg-transparent  w-full p-5 text-lg text-gray-800 bg-white border-0 dark:bg-gray-800 focus:ring-0 dark:text-white dark:placeholder-gray-400"
