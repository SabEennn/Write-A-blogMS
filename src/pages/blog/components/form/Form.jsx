      ...
      <form className="m-10 border-2 p-10">
        ...
        <div className="title-wrapper">
          ...
          <textarea
            id="message"
            rows="4"
            className="bg-slate-100 focus:bg-transparent focus:outline-none block p-2.5 w-full text-lg text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 border-none"
