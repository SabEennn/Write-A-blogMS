    ...
    <div>
      <nav className="bg-white border-gray-200 dark:bg-gray-900">
        <div className="max-w-screen-xl mx-auto p-4">
          ...
          {/* Mobile Menu */}
          <div
            className="items-center justify-between hidden w-full md:hidden mt-4"
            id="navbar-search"
          >
            ...
            {isLoggedin ? (
              <ul className="flex flex-col space-y-2 font-medium border border-gray-100 rounded-lg bg-gray-50 p-4 dark:bg-gray-800 dark:border-gray-700">
                <li>
                  <Link
                    to="/blog/add"
                    className="block py-2 px-3 text-blue-700 rounded hover:bg-gray-100 dark:text-blue-500 dark:hover:bg-gray-700"
                  >
                    Create Blog
                  </Link>
                </li>
